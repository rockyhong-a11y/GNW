...
정보 구성은 **네이버 게임 · 인벤 · 디스이즈게임 · TapTap** 의 일정/DB를
참조하여 재구성했습니다.
...
> 참조 사이트: [네이버 게임](https://game.naver.com/) · [인벤](https://www.inven.co.kr/) · [디스이즈게임](https://www.thisisgame.com/) · [TapTap](https://www.taptap.io/)
